...
func bishop(piece base.IPiece, board base.IBoard, excludeCheckExpose bool) []base.ICoord {
	...
	switch board.Dim().(type) {
	case rect.Coord:
		d = append(d, northWest(piece, board, excludeCheckExpose)...)
		d = append(d, northEast(piece, board, excludeCheckExpose)...)
		d = append(d, southWest(piece, board, excludeCheckExpose)...)
		d = append(d, southEast(piece, board, excludeCheckExpose)...)
	default:
		panic("invalid coord type")
	}
	return d
...
// Set excludeCheckExpose to true to exclude check exposing path.
// Returns a slice of destination coords.
func northWest(piece base.IPiece, board base.IBoard, excludeCheckExpose bool) []base.ICoord {
	bH, pY := board.Dim().(rect.Coord).Y, piece.Coord().(rect.Coord).Y
	pX := piece.Coord().(rect.Coord).X
	result := []base.ICoord{}
...
// Set excludeCheckExpose to true to exclude check exposing path.
// Returns a slice of destination coords.
func northEast(piece base.IPiece, board base.IBoard, excludeCheckExpose bool) []base.ICoord {
	bH, pY := board.Dim().(rect.Coord).Y, piece.Coord().(rect.Coord).Y
	pX, bW := piece.Coord().(rect.Coord).X, board.Dim().(rect.Coord).X
	result := []base.ICoord{}
...
// Set excludeCheckExpose to true to exclude check exposing path.
// Returns a slice of destination coords.
func southWest(piece base.IPiece, board base.IBoard, excludeCheckExpose bool) []base.ICoord {
...
// Set excludeCheckExpose to true to exclude check exposing path.
// Returns a slice of destination coords.
func southEast(piece base.IPiece, board base.IBoard, excludeCheckExpose bool) []base.ICoord {
	pX, pY := piece.Coord().(rect.Coord).X, piece.Coord().(rect.Coord).Y
